define(function(require) {
  ...
  var logger = PF.logger.get_logger('root/js/apps/about/show/view');
  logger.trace('require:lambda - enter');

  PF.module('AboutApp.Show.Views', function(Views, PF, Backbone, Marionette, $, _) {
    logger.trace('PF.module:AboutApp.Show.Views - enter');
    ...
    logger.trace('PF.module:AboutApp.Show.Views - exit');
  });
