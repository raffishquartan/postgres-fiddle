...
sudo -u postgres psql -c "CREATE SCHEMA pf AUTHORIZATION postgres_fiddle;" postgres_fiddle
sudo -u postgres psql -c 'CREATE EXTENSION "uuid-ossp" SCHEMA pf;' postgres_fiddle
